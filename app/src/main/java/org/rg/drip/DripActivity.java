...
public class DripActivity extends BaseActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Observable<WordR> observable =
				Observable.create(new ObservableOnSubscribe<WordR>() {
					@Override
					public void subscribe(final ObservableEmitter<WordR> emitter) throws
					                                                                    Exception {
						BmobQuery<WordR> query = new BmobQuery<WordR>();
						query.addWhereContains(WordConstant.WORD, "word")
