...
public class AvatarFragment extends BaseSubFragment implements AvatarContract.View {
	...
	protected void initView(Bundle savedInstanceState) {
		...
		List<String> popupItemData = Arrays.asList(getString(R.string.act_sign_out),
		                                           getString(R.string.act_verify_email),
		...
		mListPopup = new QMUIListPopup(getContext(),
		                               ...
		                               new ArrayAdapter<>(getContext(),
		                                                  R.layout.user_fragment_avatar_popup_list_item,
		                                                  popupItemData));
	...
	public void showConfirmSignOutDialog() {
		new QMUIDialog.MessageDialogBuilder(getActivity()).setTitle(getString(R.string.act_sign_out))
	...
	public void showVerifyEmailDialog() {
		new QMUIDialog.MessageDialogBuilder(getActivity()).setTitle(getString(R.string.act_verify_email))
		                                                  .setMessage(getString(R.string.ask_verify_email))
		                                                  .addAction(getString(R.string.chk_no),
		                                                             (dialog, index) -> dialog.dismiss())
		                                                  .addAction(getString(R.string.chk_out), (dialog, index) -> {
	...
	public void showChangeEmailDialog() {
		new QMUIDialog.EditTextDialogBuilder(getContext()).setPlaceholder(R.string.tip_input_new_email)
	...
	public void showConfirmChangePasswordDialog() {
		new QMUIDialog.MessageDialogBuilder(getActivity()).setTitle(getString(R.string.act_change_password))
