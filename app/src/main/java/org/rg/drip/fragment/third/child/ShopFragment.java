package org.rg.drip.fragment.third.child;
...
import org.rg.drip.fragment.third.child.child.ContentFragment;
import org.rg.drip.fragment.third.child.child.MenuListFragment;
...
public class ShopFragment extends SupportFragment {
    ...
    private void initView(View view, Bundle savedInstanceState) {
        ...
        if (findChildFragment(MenuListFragment.class) == null) {
            ArrayList<String>
		            listMenus = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.array_menu)));
