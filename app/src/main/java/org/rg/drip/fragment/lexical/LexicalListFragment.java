...
public class LexicalListFragment extends BaseSubFragment implements QMUITabSegment.OnTabSelectedListener,
	...
	private void addLexical(Lexical lexical) {
	...
	private void addLexicalItem(int lexicalId, LexicalItem lexicalItem) {
	...
	public void onPageSelected(int position) {
		GlobalData.currentLexicalId = mLexicalList.get(position).getId();
	}
